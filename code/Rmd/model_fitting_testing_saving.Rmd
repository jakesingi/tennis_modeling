---
title: "Model Fitting, Testing, and Saving"
...
train_bayesian_bt = function(model_file_path, test_month, max_rank, winner_y, N, time_type, model_variable) {
  ...
  train = atp_match_dat %>%
    filter(month < test_month,
          winner_id %in% players_to_rate, loser_id %in% players_to_rate)
  test = atp_match_dat %>%
    filter(month == test_month,
           winner_id %in% players_to_rate, loser_id %in% players_to_rate)
  ...
  model_data = list(J = J, N_hard = Nhard, N_clay = Nclay, N_grass = Ngrass, 
                  ...
                  grainsize=1)
  fit = fit$sample(model_data, chains = 4, parallel_chains = 4, threads_per_chain = 2, refresh = 200, iter_sampling=500, iter_warmup=500) 
  ...
  res = list(skill_draws=skill_draws, skill_summaries=skill_summaries, overall_skills_by_surface=overall_skills_by_surface, pp_p1_win_prob_draws = probs1, 
             pp_y_draws = preds1, posterior_mean_df=posterior_mean_df, test=test, model_acc = model_acc, ranking_acc = ranking_acc,
...
for (i in 1:length(test_months)) {  
  ...
  print(paste("TRAINING WINDOW: 2009-01-01 - UP TO AND NOT INCLUDING TEST MONTH:", test_month_i))
  ...
  print("Training New NegBin Sets Model")
  multi_norm_negbin_sets_train_out = train_bayesian_bt("../stan/new_model.stan", test_month_i, max_rank, "sets_won_loser", "best_of", "static", "sets")
  ...
  acc_list$ranking= c(acc_list$ranking, multi_norm_sets_train_out$ranking_acc)
  ...
  print(paste("Ranking accuracy:", multi_norm_sets_train_out$ranking_acc))
}
```

```{r}
# Save multi norm games model
saveRDS(multi_norm_games_skill_draws, file = "./multi_normal_models/multi_normal_games_skill_draws.RData")
saveRDS(multi_norm_games_skill_summaries, file = "./multi_normal_models/multi_normal_games_skill_summaries.RData")
saveRDS(multi_norm_games_post_mean_dfs, file = "./multi_normal_models/multi_normal_games_post_mean_dfs.RData")
saveRDS(multi_norm_games_test_frames, file = "./multi_normal_models/multi_normal_games_test_frames.RData")
saveRDS(multi_norm_games_train_times, file = "./multi_normal_models/multi_normal_games_train_times.RData")
saveRDS(multi_norm_games_train_out$overall_skills_by_surface, file = "./multi_normal_models/multi_normal_games_overall_skills_by_surface")
write.csv(acc_list$multi_norm_games_acc, "./multi_normal_models/multi_normal_games_test_acc.csv", row.names = F)

# Save multi norm sets model
saveRDS(multi_norm_sets_skill_draws, file = "./multi_normal_models/multi_normal_sets_skill_draws.RData")
saveRDS(multi_norm_sets_skill_summaries, file = "./multi_normal_models/multi_normal_sets_skill_summaries.RData")
saveRDS(multi_norm_sets_post_means_dfs, file = "./multi_normal_models/multi_normal_sets_post_mean_dfs.RData")
saveRDS(multi_norm_sets_test_frames, file = "./multi_normal_models/multi_normal_sets_test_frames.RData")
saveRDS(multi_norm_sets_train_times, file = "./multi_normal_models/multi_normal_sets_train_times.RData")
write.csv(acc_list$multi_norm_sets_acc, "./multi_normal_models/multi_normal_sets_test_acc.csv", row.names = F)

# Save multi norm negbin sets model
saveRDS(multi_norm_negbin_sets_skill_draws, file = "./multi_normal_models/multi_normal_negbin_sets_skill_draws.RData")
saveRDS(multi_norm_negbin_sets_skill_summaries, file = "./multi_normal_models/multi_normal_negbin_sets_skill_summaries.RData")
saveRDS(multi_norm_negbin_sets_post_mean_dfs, file = "./multi_normal_models/multi_normal_negbin_sets_post_mean_dfs.RData")
saveRDS(multi_norm_negbin_sets_test_frames, file = "./multi_normal_models/multi_normal_negbin_sets_test_frames.RData")
saveRDS(multi_norm_negbin_sets_train_times, file = "./multi_normal_models/multi_normal_negbin_sets_train_times.RData")
write.csv(acc_list$multi_norm_negbin_sets_acc, "./multi_normal_models/multi_normal_negbin_sets_test_acc.csv", row.names = F)

# Save multi t games sets model
saveRDS(multi_t_games_skill_draws, file = "./multi_t_models/multi_t_games_skill_draws.RData")
saveRDS(multi_t_games_skill_summaries, file = "./multi_t_models/multi_t_games_skill_summaries.RData")
saveRDS(multi_t_games_post_mean_dfs, file = "./multi_t_models/multi_t_games_post_mean_dfs.RData")
saveRDS(multi_t_games_test_frames, file = "./multi_t_models/multi_t_games_test_frames.RData")
saveRDS(multi_t_games_train_times, file = "./multi_t_models/multi_t_games_train_times.RData")
write.csv(acc_list$multi_t_games_acc, "./multi_t_models/multi_t_games_test_acc.csv", row.names = F)

# Save multi t sets sets model
saveRDS(multi_t_sets_skill_draws, file = "./multi_t_models/multi_t_sets_skill_draws.RData")
saveRDS(multi_t_sets_skill_summaries, file = "./multi_t_models/multi_t_sets_skill_summaries.RData")
saveRDS(multi_t_sets_post_means_dfs, file = "./multi_t_models/multi_t_sets_post_mean_dfs.RData")
saveRDS(multi_t_sets_test_frames, file = "./multi_t_models/multi_t_sets_test_frames.RData")
saveRDS(multi_t_sets_train_times, file = "./multi_t_models/multi_t_sets_train_times.RData")
write.csv(acc_list$multi_t_sets_acc, "./multi_t_models/multi_t_sets_test_acc.csv", row.names = F)

# Save multi t negbin sets model
saveRDS(multi_t_negbin_sets_skill_draws, file = "./multi_t_models/multi_t_negbin_sets_skill_draws.RData")
saveRDS(multi_t_negbin_sets_skill_summaries, file = "./multi_t_models/multi_t_negbin_sets_skill_summaries.RData")
saveRDS(multi_t_negbin_sets_post_mean_dfs, file = "./multi_t_models/multi_t_negbin_sets_post_mean_dfs.RData")
saveRDS(multi_t_negbin_sets_test_frames, file = "./multi_t_models/multi_t_negbin_sets_test_frames.RData")
saveRDS(multi_t_negbin_sets_train_times, file = "./multi_t_models/multi_t_negbin_sets_train_times.RData")
write.csv(acc_list$multi_t_negbin_sets_acc, "./multi_t_models/multi_t_negbin_sets_test_acc.csv", row.names = F)
```
