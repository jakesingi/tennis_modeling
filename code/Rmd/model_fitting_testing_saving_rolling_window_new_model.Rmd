...
test_months = months[months >= first_test_month][base::sample(1:92, size = 10, replace = F, prob = rep(1/92, 92))]

to_rerun = c("2010-02-01", "2010-06-01", "2010-07-01", "2011-07-01", "2012-02-01", "2012-03-01", "2012-04-01", "2013-04-01", "2013-05-01", "2013-06-01", "2013-07-01", "2013-09-01", "2014-01-01", "2014-02-01", "2014-04-01", "2014-07-01", "2015-06-01", "2015-07-01", "2016-08-01", "2017-06-01")
...
saveRDS(multi_t_negbin_sets_skill_summaries, file = "./multi_t_models2/rerun_multi_t_negbin_sets_skill_summaries.RData")
saveRDS(multi_t_negbin_sets_post_mean_dfs, file = "./multi_t_models2/rerun_multi_t_negbin_sets_post_mean_dfs.RData")
saveRDS(multi_t_negbin_sets_test_frames, file = "./multi_t_models2/rerun_multi_t_negbin_sets_test_frames.RData")
saveRDS(multi_t_negbin_sets_train_times, file = "./multi_t_models2/rerun_multi_t_negbin_sets_train_times.RData")
write.csv(acc_list$multi_t_negbin_sets_acc, "./multi_t_models2/rerun_multi_t_negbin_sets_test_acc.csv", row.names = F)
```
